...
class AutoPause {
  constructor() {
    this.handleObserve = this.handleObserve.bind(this); //umbral de viewport del video
...
var AutoPause_js_1 = __importDefault(require("./plugins/AutoPause.js"));
...
var player = new MediaPlayer_1.default({
  el: video,
  plugins: [new AutoPlay_1.default(), new AutoPause_js_1.default()]
});
...
},{"./MediaPlayer":"assets/MediaPlayer.ts","./plugins/AutoPlay":"assets/plugins/AutoPlay.ts","./plugins/AutoPause.js":"assets/plugins/AutoPause.js","C:\\Users\\andre\\Documents\\Proyectos\\platzi-javascript-profesional\\sw.js":[["sw.js","sw.js"],"sw.js.map","sw.js"]}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
